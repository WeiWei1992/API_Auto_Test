...
def send_email():
    ...
    try:
        ...
        smtpObj.login('weiwei.uh@haier.com','Wwcmx070933125')
...
if __name__=="__main__":
    #send_email()
    # "uhomeUserId": (.* ?)
    mystr='{"retCode":"00000","retInfo":"操作成功","data":{"createfamilies":[{"createTime":"2020-10-21 14:54:22","familyMembers":null,"familyOwner":"100019957366179891","appId":null,"familyOwnerInfo":null,"familyId":"499172553662000000","familyName":"我的家庭","familyPosition":null,"locationChangeFlag":false,"familyDeviceCount":"0","familyUserCount":"1","familyVirtUserCount":"0","familyLocation":{"longitude":null,"latitude":null,"cityCode":null},"rooms":null,"isDefault":1},{"createTime":"2020-10-21 14:54:22","familyMembers":null,"familyOwner":"100019957366179891","appId":"MB-UZHSH-0000","familyOwnerInfo":null,"familyId":"499172553662000001","familyName":"我的家","familyPosition":"北京 朝阳","locationChangeFlag":false,"familyDeviceCount":"0","familyUserCount":"1","familyVirtUserCount":"0","familyLocation":{"longitude":116.45011,"latitude":39.92767,"cityCode":"101010300"},"rooms":null,"isDefault":0}],"joinfamilies":[]}}'
    #pattern1='"createfamilies".*"familyId":(.*?)'
    pattern1='"familyId":"(.*?)",'
    pattern = re.compile(pattern1)
    print(pattern)

    result1 = pattern.findall(mystr)
    print(result1)

    # pattern2='"createfamilies".*"familyId":(.* ?)'
    # pattern2=re.compile(pattern2)
    # print(pattern2)
    # res2=pattern2.findall(pattern2)
    # print(res2)
